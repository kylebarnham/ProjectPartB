...
public class App extends Application {
    ...
    private static Scene vehicleEdit;
    ...
    public void start(Stage stage) throws IOException {
        ...
        Parent rootCustEdit = FXMLLoader.load(getClass().getResource("customerEdit.fxml"));
        ...
        Parent rootVehicleEdit = FXMLLoader.load(getClass().getResource("vehicleEdit.fxml"));
        ...
        Parent rootRentEdit = FXMLLoader.load(getClass().getResource("rentalEdit.fxml"));
        ...
        custEdit = new Scene(rootCustEdit);
        ...
        vehicleEdit = new Scene(rootVehicleEdit);
        ...
        rentEdit = new Scene(rootRentEdit);
    ...
    public static void changeScene(int sc)
    {
        switch(sc) { 
            ...
            case 5: stage.setScene(custEdit); break;
            ...
            case 11: stage.setScene(vehicleEdit); break;
            case 12: stage.setScene(vehicleDelete); break;
            case 13: stage.setScene(rentMenu); break;
            case 14: stage.setScene(rentAdd); break;
            case 15: stage.setScene(rentView); break;
            //case 16: stage.setScene(rentFind); break;
            case 17: stage.setScene(rentEdit); break;
